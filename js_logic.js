...
guessImageForm.addEventListener('submit', (el) => {
...
coordinateFindImage.addEventListener('click', (eventObj) => {

    coordinateFindP.innerText = `Treasure is at (${eventObj.clientX},${eventObj.clientY}) of browser window,
									(${eventObj.screenX}, ${eventObj.screenY}) of user screen,
									(${eventObj.pageX}, ${eventObj.pageY}) of browser's page.`;
...
windowHeight.innerText = `Window height: ${window.innerHeight} and width: ${window.innerWidth},
						   Window location: ${loc}`;
